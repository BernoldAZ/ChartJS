...
})({"aYzw1":[function(require,module,exports) {
...
},{}],"n0lrN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _auto = require("chart.js/auto"); // loading all components
var _autoDefault = parcelHelpers.interopDefault(_auto);
function data_generate(func, from, to, step) {
    var array_x1 = [];
    var array_y1 = [];
    for(let x = from; x <= to; x += step){
        array_x1.push(Math.round(x * 100) / 100);
        array_y1.push(eval(func));
    }
    return [
        array_x1,
        array_y1
...
},{}]},["aYzw1","n0lrN"], "n0lrN", "parcelRequire30ab")
